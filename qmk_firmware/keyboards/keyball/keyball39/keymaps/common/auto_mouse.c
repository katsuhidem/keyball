...
bool auto_mouse_process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    case KC_MY_BTN1:
    case KC_MY_BTN2:
    case KC_MY_BTN3:
...
report_mouse_t auto_mouse_pointing_device_task_user(report_mouse_t mouse_report) {
